...
export default function Home() {
    return (
        <>      
        <title>Artificial General/Super Intelligence: Overview @ davidhuang.blog</title>  
        <div className={`p-32 bg-gradient-to-br from-orange-200 from-5% via-amber-400 via-30% to-pink-200 to-90% h-screen w-screen space-y-4`}>
            ...
            <div className="bg-white p-4 rounded-lg border-b-slate-200 shadow-xl">
                <p className="text-3xl">Artificial General/Super Intelligence: Overview</p>
            </div>
            <div className="bg-white p-4 rounded-lg border-b-slate-200 shadow-xl">
                <div className="flex space-x-6">
                    {/* Column 1 */}
                    <div className="flex-1">
                        <h2 className="font-bold text-xl mb-2">Basics</h2>
                        <ul className="list-disc pl-5">
                            
                            <li><Link href="/wiki/agsi/overview/definitions" className="text-blue-500 hover:underline">Definitions of Artificial General/Super Intelligence</Link></li>
                        </ul>
                    </div>
